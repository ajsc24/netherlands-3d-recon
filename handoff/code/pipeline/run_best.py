# =============================================================================
# HANDOFF ANNOTATION — run_best.py
# =============================================================================
# PURPOSE: Best-quality orchestrator for existing COLMAP workspace
# FLOW:    (1) wall re-fusion  (2) mesh_wall.ply  (3) OpenMVS  (4) pick_best
# ENTRY:   Run-Best.ps1, Run-Resume-Best.ps1 (--skip-refusion)
# FLAGS:   --skip-refusion, --skip-openmvs, --openmvs-only
# SEE:     handoff/docs/ARCHITECTURE.md
# =============================================================================
