# =============================================================================
# HANDOFF ANNOTATION — run_openmvs.py
# =============================================================================
# PURPOSE: OpenMVS densify → mesh → texture from COLMAP dense workspace
# OPENMVS 2.4 QUIRK: ReconstructMesh writes scene_mesh.ply ONLY (no .mvs file)
#          Use: TextureMesh -i scene_dense.mvs -m scene_mesh.ply
# CONFIG:  import_sparse_only hides fused.ply to avoid 22M point import crash
#          decimate must be float (0.5), not int
# SEE:     handoff/docs/KNOWN_ISSUES.md #5, #7
# =============================================================================
