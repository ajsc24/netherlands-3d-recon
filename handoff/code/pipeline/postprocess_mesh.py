# =============================================================================
# HANDOFF ANNOTATION — postprocess_mesh.py
# =============================================================================
# PURPOSE: Clean fused.ply and build Poisson mesh via PyMeshLab (+ COLMAP fallback)
# INPUT:   colmap/dense/fused.ply
# OUTPUT:  mesh_final.ply or mesh_wall.ply, fused_*_filtered.ply
# OOM GUARD: max_poisson_points subsamples before Poisson (default 3M)
