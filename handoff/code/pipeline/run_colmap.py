# =============================================================================
# HANDOFF ANNOTATION — run_colmap.py
# =============================================================================
# PURPOSE: Full COLMAP SfM + dense MVS with optional drone masks
# STAGES:  feature_extract → match → mapper → pick_best_sparse_model →
#          undistort → patch_match_stereo → fusion → poisson → postprocess
# KEY FN:  pick_best_sparse_model() — selects sparse/N with most registered images
# GPU:     CUDA required for patch_match_stereo on this build
