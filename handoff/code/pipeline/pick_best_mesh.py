# =============================================================================
# HANDOFF ANNOTATION — pick_best_mesh.py
# =============================================================================
# PURPOSE: Score mesh candidates; copy winner to mesh_best.ply
# SCORE:   bbox_diagonal × sqrt(face_count) — prefers coverage + detail
# SKIPS:   Files >400MB (mesh_wall.ply) to avoid PyMeshLab OOM
