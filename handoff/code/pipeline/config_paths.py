# =============================================================================
# HANDOFF ANNOTATION — config_paths.py
# =============================================================================
# PURPOSE: Load YAML configs; resolve relative paths (video, work_dir, colmap_exe)
#          to absolute paths based on config file location (project root).
# INPUT:   Path to any config_*.yaml
# OUTPUT:  dict with absolute paths; helpers for frame/mask directories
